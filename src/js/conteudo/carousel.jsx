        ...
        return (
            <div className="carousel">
                            ...
                            interval={this.state.intervalo} autoPlay={this.state.rodar_sozinho} transitionTime={this.state.tempo_transicao} dynamicHeight={this.state.ajustar_altura}>
                                <div>
                                    <img src="https://img.elo7.com.br/product/zoom/FBCE34/adesivo-paisagem-praia-decorando-com-adesivos.jpg" alt="" />
                                    {/* <p className="legend">Imagem 1</p> */}
                                </div>
                                <div>
                                    <img src="https://http2.mlstatic.com/painel-paisagem-praia-coqueiros-400-x-200-multi-D_NQ_NP_203525-MLB25461274818_032017-F.jpg" alt="" />
                                    {/* <p className="legend">Imagem 2</p> */}
                                </div>
                                <div>   
                                    <img src="https://img.elo7.com.br/product/original/115E580/painel-paisagem-g-frete-gratis-decoracao-de-festa.jpg" alt="" />
